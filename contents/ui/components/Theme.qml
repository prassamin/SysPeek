...
QtObject {
    ...
    readonly property color bgBase: Qt.rgba(0.14, 0.15, 0.19)
    ...
    readonly property color accentDim: Qt.rgba(0.5, 0.55, 0.97, 0.15)
    readonly property color accentGlow: Qt.rgba(0.5, 0.55, 0.97, 0.08)
    // Silk White & Warm Lavender-Slate Typography
    readonly property color textPrimary: Qt.rgba(0.98, 0.98, 1, 0.95)
    ...
    readonly property color dangerCol: "#f43f5e"
    // Premium Rose Red
    readonly property color successCol: "#10b981"
    // Premium Emerald Green
    readonly property color warningCol: "#f59e0b"
}
